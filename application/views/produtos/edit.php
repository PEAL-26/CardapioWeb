...
<div class="row">
    <?php echo form_open_multipart('produto/edit/' . $produto->id, '', array("id" => $produto->id)); ?>
    <div class="row">
    ...
    <div class="row">
        <div class="file-field input-field col s6">
            ...
            <div class="file-path-wrapper">
                <input name="imagem" placeholder="Localizar imagem" class="file-path validate" type="text" value="<?php echo set_value('imagem', $produto->imagem); ?>">
            </div>
